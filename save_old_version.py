...
for i in range(len(images_tk)):
    ...
    display.show_image_tk_2(frame, black_image_tk, image_name)
    ...
    display.show_image_tk_2(frame, images_tk[i], image_name)
    root.update_idletasks()
    root.update()
...
for i in range(len(png_tk)):
    ...
    display.show_image_tk_2(frame, png_tk[i], image_names[i])
    root.update_idletasks()
    root.update()
