...
for j in range(0,nb_layers, subset_imagetk):                                                            # double loop over the image objects can be used to improve performance of the printer by creating a subset of image objects each time
    ...
    for i in range(len(images_tk)): 
        ...
        sleep(2)
        motor2.move_dist_time_dir_dm(2-layer_thickness,0.4,-1,1)
        sleep(2)
        ...
        if layer_index<=3:
            cure_time =50                                                                               # 12 for commercial resin, 96 for custom resin 1, 
        else:
            cure_time=20                                                                                # 2.8 for commercial resin, 25 for custom resin 1, 
